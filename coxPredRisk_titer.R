...
# Description : Performs survival analysis using the titer measurements
# Cite        : TBD
# ******************************************************************************
...
dir_res = paste('results_coxPred_titer/',sep="")
dir.create(dir_res)
...
thresh_upf = 0.7 # polyserial coefficient threshold
...
luminex = read.csv('in/luminex_titer.csv', header=TRUE, row.names=1)
